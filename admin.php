...
<div class="wrapper row1">
  <header id="header" class="clear">
    <div id="hgroup">
      <h1><a href="index.html">Limbo</a></h1>
      <h2>Lost something? We found it</h2>
    </div>
    <nav>
      <ul>
        ...
        <li class="last"><a href="qlinks.php">Quick Links</a></li>
      </ul>
    </nav>
  </header>
</div>
  ...
  <div id="container" class="clear">
    ...
    <div id="homepage">
      <form action="presidents_login.php" method="POST">
          <table>
              <tr>
                  <td font-size="50px">Username:</td><td><input type="text" name="lname"></td>
              </tr>
              <tr>
                  <td>Password:</td><td><input type="text" name="lname"></td>
              </tr>
          </table>
